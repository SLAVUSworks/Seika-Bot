...
with open(r'C:\Users\Slavus\OneDrive\Desktop\Slavus\BTRI-bot\ApiKey.txt') as f:
    openai.api_key  = f.readline()

with open(r'C:\Users\Slavus\OneDrive\Desktop\Slavus\BTRI-bot\BotKey.txt') as f:
    BotKey =  f.readline()

@client.event
async def on_ready():
    await client.change_presence(status=discord.Status.idle, activity=discord. Activity(type=discord.ActivityType.watching, name='Slavus Bot Development'))
    print('Melogin {0.user}'.format(client))
